...
3. The user will authenticate to their institution's Identity Provider via their usual means. This will sometimes require selecting their Identity Provider from a list of providers at the AAF Discovery Service
